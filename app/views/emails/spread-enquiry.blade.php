...
<head>
	<meta charset="utf-8" />
	<title>Spread the Cost Enquiry</title>
	<style type="text/css">
		...
		<table width="600px">
			<tr>
				<td>
					...
					<p>Someone has applied to spread the cost, the details are below:</p>
				</td>
			</tr>
		</table>
	</div>
		...
		<table width="600px">
			<tr style="background-color:#e6e6e6;">
				<td style="padding:15px;">
                    ...
                    <p><b>Purpose of Loan:</b>&nbsp;{{ $_POST['purpose-of-loan'] }}</p>
                    <p><b>Name of company purchasing from:</b>&nbsp;{{ $_POST['company_purchase_from'] }}</p>
