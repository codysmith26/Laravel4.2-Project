				...
				<div class="medium-12 columns">
					<div class="row">
						<div class="small-12 large-7 columns">
							<h3>Qi Finance: Guernsey</h3>
						</div>
						<div class="small-12 large-5 columns">
							<h5 class="mapBuffer">Other Maps:&nbsp;&nbsp;<a href="{{ url('/contact') }}">Jersey</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="{{ url('/contact-iom') }}">Isle of Man</a></h5>
						</div>
					</div>
					<hr>
					<head>
							...
							<body>
								...
								<script>
								    ...
								    document.addEventListener('DOMContentLoaded', drawMapguernsey);

									var map;
									var guernseyLatLng = new google.maps.LatLng(49.45449, -2.53676);
									var image = '/images/skin/quidsin-pin.png';
									var marker;

									function drawMapguernsey() {

										var mapOptions = {
										    zoom: 17,
										    center: guernseyLatLng
										  };
