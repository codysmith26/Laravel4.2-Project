{{-- Start form --}}
	{{ Form::open(array('url' => 'spread-success', 'data-abide')) }}
{{-- Start Loan Particulars --}}
	    <fieldset>
		<legend><strong>(1/8)</strong> Spread the Cost Particulars</legend>
{{-- Start Amount Slider --}}
		<div class="row collapse">
		    ...
		    <div class="small-3 columns" style="text-align:right;margin-top:23px;">£25,000</div>
		</div>
		<div class="row collapse">
		    <div id="slider"></div>
		</div>
		<div class="row collapse">
		    <h5 style="text-align:center;font-weight:900;color:#666666;">Spread the Cost Amount</h5>
		</div>
{{-- End Amount Slider --}}
		<hr />
{{-- Start Term Slider --}}
		...
		<div class="row collapse">
		    <h5 style="text-align:center;font-weight:900;color:#666666;">Term you’d like to Spread the Cost Over</h5>
		</div>
{{-- End Term Slider --}}
		<hr />
{{-- Start Repayments Box --}}
		<div class="row">
		    ...
		    <h5 style="text-align:center;font-weight:900;color:#666666;">Monthly Payments</h5>
		</div>
		<div class="row">
...
<fieldset>
    <legend><strong>(5/8)</strong> What are you Purchasing?</legend>
    <div class="row">
	      <div class="small-12 columns">
    	    <p>Purpose of Loan:</p>
    	    {{ Form::text('purpose-of-loan', '', array('placeholder' => 'Enter here', 'required', 'MaxLength' => '90')) }}
          <small class="error">Please enter the purpose of loan</small> 
	      </div>
    	</div>

    <div class="row">
	      <div class="small-12 columns">
    	    <p>Name of company you’re purchasing from:</p>
    	    {{ Form::text('company_purchase_from', '', array('placeholder' => 'Enter here', 'required', 'MaxLength' => '90')) }}
          <small class="error">Please enter the name of company you’re purchasing from</small> 
	      </div>
    	</div>
</fieldset>
...
<fieldset>
    ...
    <div class="row">
	<div class="small-12 columns">
	    <p>Please check the box below to confirm that you have read and accepted the <a href="/privacy-policy/">privacy statement</a> and that you understand that applying for a Qi Finance Spread the Cost Agreement will mean you may be subject to a credit check with a trusted 3rd party company, your details may also be passed onto a third party lender in the case of brokered loans.</p>
	</div>
	<div class="small-12 columns">
